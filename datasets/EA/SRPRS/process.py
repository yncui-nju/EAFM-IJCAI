...
class SRPRSDatasetPreprocessor:
    ...
    def load_dataset(self):
        ...
        mapping_dir = os.path.join(self.dataset_path, 'mapping', '0_3')
        if not os.path.exists(mapping_dir):
            print(f"Warning: mapping/0_3 directory not found in {self.dataset_path}")
            return
        ...
        self._load_alignments_from_split_files()
    ...
    def _load_triples(self, filename, kg_id):
        """加载三元组数据"""
        filepath = os.path.join(self.dataset_path, 'mapping', '0_3', filename)
...
def main():
    ...
    datasets = ['D_W_15K_V1', 'D_W_15K_V2',
                'D_Y_15K_V1', 'D_Y_15K_V2',
                'EN_DE_15K_V1', 'EN_DE_15K_V2',
                'EN_FR_15K_V1', 'EN_FR_15K_V2', ]
    base_path = ""  # 修正base_path
    output_base = "../../processed_data/SRPRS"
