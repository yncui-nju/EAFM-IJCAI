"""Fine-tune a pretrained EAFM checkpoint on target datasets."""
...
parser.add_argument("--train_dataset_list", type=str, default="OpenEA#D_W_15K_V1")
parser.add_argument("--valid_dataset_list", type=str, default="OpenEA#D_W_15K_V1")
parser.add_argument("--test_dataset_list", type=str, default="OpenEA#D_W_15K_V1")
...
if __name__ == "__main__":
    ...
    for epoch in tqdm(range(args.n_epochs)):
        experiment.train_batch(max_step=int(args.max_step), finetune=True)
